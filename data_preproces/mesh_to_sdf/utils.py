...
def sample_uniform_points_in_voxels(voxels, num_samples, voxel_size):
    samples = (np.random.rand(voxels.shape[0], num_samples, 3)*2-1)*2*voxel_size
    samples = voxels[..., None, :3] + samples
